...
if [ "$UID" -ne 0 ]
then
 echo "Superuser rights required. This is a long line. Markdown is really good and eay used. But writing code is very hard."
 exit 2
fi
...
```
<img src="example.png" alt="Image with relative path" />
```

<img src="example.png" width="80%" alt="IMG RELATIVE" />
